namespace MVCHomeWork1.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶資訊檢視表Repository Get客戶資訊檢視表Repository()
		{
			var repository = new 客戶資訊檢視表Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶資訊檢視表Repository Get客戶資訊檢視表Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶資訊檢視表Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
